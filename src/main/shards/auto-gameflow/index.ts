    ...
    if (this._lc.data.chat.conversations.customGame && this.state.willSearchMatch) {
      if (cancel === 'normal') {
        this._lc.api.chat
          .chatSend(
            this._lc.data.chat.conversations.customGame.id,
            `[SadeRift] ${i18next.t('auto-gameflow-main.auto-matchmaking-canceled')}`,
            'celebration'
          )
          .catch(() => {})
        return
        ...
        this._lc.api.chat
          .chatSend(
            this._lc.data.chat.conversations.customGame.id,
            `[SadeRift] ${i18next.t('auto-gameflow-main.auto-matchmaking-canceled-wait-for-invitees')}`,
            'celebration'
          )
          .catch(() => {})
        return
        ...
        this._lc.api.chat
          .chatSend(
            this._lc.data.chat.conversations.customGame.id,
            `[SadeRift] ${i18next.t('auto-gameflow-main.auto-matchmaking-canceled-not-leader')}`,
            'celebration'
          )
          .catch(() => {})
        return
        ...
        this._lc.api.chat
          .chatSend(
            this._lc.data.chat.conversations.customGame.id,
            `[SadeRift] ${i18next.t('auto-gameflow-main.auto-matchmaking-canceled-wait-for-penalty')}`,
            'celebration'
          )
          .catch(() => {})
        return
      ...
      this._lc.api.chat
        .chatSend(
          this._lc.data.chat.conversations.customGame.id,
          `[SadeRift] ${i18next.t('auto-gameflow-main.auto-matchmaking-in', { seconds: Math.abs(time).toFixed() })}`,
          'celebration'
        )
        .catch(() => {})
    }
